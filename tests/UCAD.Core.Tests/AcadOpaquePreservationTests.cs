...
public sealed class AcadOpaquePreservationTests
{
    ...
    public void UntouchedImportedDocumentExportsExactOriginalContainer()
    {
        ...
        document.AttachAutoCadSourceEnvelope(new CadAutoCadSourceEnvelope(
            original,
            ".dwg",
            "AC1032",
            proxyEntityCount: 1,
            preservationReasons: ["proxy entity"]));
    ...
    public void EditedDocumentUsesSemanticDwgAndWarnsThatOpaqueDataWasNotMerged()
    {
        ...
        document.AttachAutoCadSourceEnvelope(new CadAutoCadSourceEnvelope(
            ...
            "AC1032",
            proxyObjectCount: 1,
            preservationReasons: ["custom object"]));
        ...
        Assert.Contains(exported.Warnings, warning =>
            warning.Contains("cannot yet be merged", StringComparison.OrdinalIgnoreCase) &&
            warning.Contains("original", StringComparison.OrdinalIgnoreCase));
    }
    ...
    public void OriginalContainerRemainsRecoverableAfterDocumentEdits()
    {
        ...
        document.AttachAutoCadSourceEnvelope(new CadAutoCadSourceEnvelope(
            ...
            "AC1032",
            customClassCount: 3,
            preservationReasons: ["ObjectARX classes"]));
    ...
    public void NativeUcadPersistenceRetainsAndVerifiesOpaqueSourceEnvelope()
    {
        ...
        document.AttachAutoCadSourceEnvelope(new CadAutoCadSourceEnvelope(
            ...
            proxyObjectCount: 1,
            customClassCount: 4,
            preservationReasons: ["proxy entity", "custom class"]));
